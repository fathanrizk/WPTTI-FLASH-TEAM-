...
<html lang="en" dir="ltr">
  ...
  <body>
    ...
    <div class="main">
      ...
      <a
      <button type="button" class="btn btn-lg btn-primary" href="<?= base_url('index.php/user daftartes');?>" style="margin-left:auto; margin-right:auto; display: block;">Daftar Test</button>
      </a>
