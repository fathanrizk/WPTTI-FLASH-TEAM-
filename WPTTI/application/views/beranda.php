  ...
  <body>
    <div class="navi">
      <img src="<?php echo base_url() ?>/assets/img/itera.png" alt="">
        <h1>TOEFL ITERA</h1>
        <ul>
          <li><a href="#" style="padding-right: 0.5rem;">Login</a></li>
      ...
      <div class="main">
        ...
        <center>
         ...
         <button type="button" class="btn btn-lg btn-primary " style="margin-left:auto; margin-right:auto; display: block;">Register Now !</button>
